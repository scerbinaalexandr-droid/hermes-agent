...
## [2026-06-29] meeting-prep | Фаза A: calendar create --recurrence/--reminders (0d5e866da); /prep skill — повестки вопросов на встречи дня из календаря+контекста → вкладка «Встречи» (upsert), бриф по блокам (bca439033); cron `e900bfffe343` «CEO Meeting Prep 07:00 EEST» (0 4 * * *, skill prep, deliver telegram:746810595, next 2026-06-30T04:00Z). Verified --gather на проде. Фаза B (TODO): напоминание за 1ч до каждой встречи (динамич. расписание). 73 теста зелёных.
