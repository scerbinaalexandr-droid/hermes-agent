...
**Кнопки черновика (hands-free):** ВСЕГДА заканчивай черновик (entry и protocol)
строкой `[[draft_actions]]` — гейтвей рендерит кнопки ✅ Сохранить · ✏️ Дополнить ·
🗑 Удалить. Реакция: **«Сохрани текущий черновик…»** → выполни Step 3 (сохрани);
