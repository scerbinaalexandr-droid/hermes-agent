...
# Daily Briefing — направления PRJ-1–PRJ-5

**Purpose.** Утренний brief для Alexandr Scerbina (портфель направлений PRJ-1–PRJ-5, см. `memory/projects.md`). Сжатый, focused, помещается в одно Telegram-сообщение (≤4096 символов).
...
Главный фокус:
PRJ-2 — первый клиент: сегодня описать продукт «вывод собственника из операционки».

Топ-3 бизнес-приоритета:
1. PRJ-2. Вывод собственника — описать продукт: этапы, результат, цена
2. PRJ-1. Lean-консалтинг — позиционирование и описание услуги
3. PRJ-3. Экзоскелет CEO — первое интервью по бюджетированию
