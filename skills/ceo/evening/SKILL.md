...
Расскажи, как прошёл день — голосом (30–60 секунд) или текстом, свободно.
Я сам разложу: что сделал, что не пошло и почему, что переносишь,
энергия и настрой, здоровье, семья, вывод дня и фокус на завтра.

Говори как другу — порядок и слова неважны.
