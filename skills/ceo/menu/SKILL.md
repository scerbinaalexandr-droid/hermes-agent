...
☀️ /brief — рабочий фокус дня (auto в 07:30 EEST)
🌙 /evening — вечерний recap, голосом (auto-prompt 21:30)
🎤 /capture — записать мысль / задачу / решение (голосом — auto)
🗓 /prep — повестка на встречи дня: вопросы для фокуса (авто в 07:00 EEST) → таблица «Встречи»
...
✅ /tasks — открытые задачи по срокам: просрочено / на неделе / без срока (авто в 07:15)
🔍 /find <запрос> — поиск по памяти (что мы решили / когда было)

*Утилиты:*
🛠 /tune — поправить меня на ходу: «настройся / это неправильно / запомни как правило» (сам подстроюсь или поставлю баг разработчику)
...
⌨️ _Меню сворачивается после выбора — вернуть: иконка клавиатуры в поле ввода или /menu_
