...
| 🔴 Красная | ≥ $10.00 | Отчёт + строка «лучше остановить бота до конца дня» |
...
Владелец видит только деньги, по-русски. Токены, сессии и графики — не
показываются (они остаются в `/cost debug`).

```
💰 Расходы на ассистента — 17 сентября

Сегодня: $0.13 🟢
За 7 дней: $0.39 (в среднем $0.06 в день)
Сентябрь: $7.87 из $200 (4%)
При таком темпе к концу месяца: около $13.89
```

В жёлтой/красной зоне и при заметном росте расхода — отдельная строка
